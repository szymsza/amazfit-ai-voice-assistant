...
declare module 'zosLoader:./index.page.[pf].layout.js' {
  export { CANVAS_STYLE, STATE_TEXT_STYLE, QUESTION_TEXT_STYLE, ANSWER_TEXT_STYLE, QUESTION_ANSWER_GAP, DEVICE_WIDTH, DEVICE_HEIGHT } from './page/gt/home/index.page.r.layout'
}
